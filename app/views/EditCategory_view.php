            ...
            <form method="POST" action="<?=URLROOT?>CategoryController/UpdateCategory/<?= $data['category']->category_id; ?>" class="flex flex-col gap-5">
                <div class="grid grid-cols-1 gap-1 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="name" name="catName" value="<?= $data['category']->category_name; ?>" type="text" class="block w-full px-4 py-2 mt-2 text-gray-400 bg-white border border-[#685942] rounded-md focus:border-[#685942] focus:outline-none focus:ring">
