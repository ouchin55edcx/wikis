            ...
            <?php foreach ($categories as $category) : ?>
                <a href="<?php echo $category->category_id; ?>" class="w-full">
                    <div class="relative h-full">
                        <span class="absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-gray-300 rounded-lg"></span>
                        <div class="relative h-full p-5 bg-white border-2 border-gray-300 rounded-lg">
                            ...
                            <p class="mt-3 mb-1 text-xs font-medium text-gray-300 uppercase">------------</p>
                        </div>
                    </div>
                </a>
            <?php endforeach; ?>
